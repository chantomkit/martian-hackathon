"""
Open-Ended Adversarial Loop for Guardian-Loop
...
class OpenEndedAdversarialLoop:
    """Main Open-Ended loop for adversarial safety testing"""
    
    def __init__(self,
                 safety_judge: SafetyJudge,
                 tokenizer,
                 martian_client=None,
                 output_dir: str = "./outputs/open_ended"):
        """
        Initialize the Open-Ended loop
        ...
        self.archive = SafetyOpenEndedArchive()
        self.mutator = OpenEndedMutator()
    ...
    def run(self, 
        ...
        """
        Run the main Open-Ended adversarial loop
        ...
        """
        print(f"Starting Open-Ended Adversarial Loop for {n_iterations} iterations")
        
        # Initialize archive with seed prompts
        self._initialize_archive()
        
        # Main loop
        for i in tqdm(range(n_iterations), desc="Open-Ended Loop"):
    ...
    def _generate_final_report(self) -> Dict:
        """Generate final report of the Open-Ended loop"""
...
if __name__ == "__main__":
    ...
    # Create and run Open-Ended loop
    open_ended_loop = OpenEndedAdversarialLoop(
        safety_judge=judge,
        tokenizer=tokenizer,
        output_dir="./outputs/open_ended_test"
    )
    
    # Run for a small number of iterations for testing
    results = open_ended_loop.run(n_iterations=100, retrain_interval=50)
    
    # Print results
    print("\n=== Open-Ended Loop Results ===")
